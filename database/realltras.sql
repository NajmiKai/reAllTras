...
(15, 2, 'F11 – PROJECT REPORT EVALUATION FORM.pdf', 'uploads/permohonan/2/68466594c031f_2_Dokumen_Sokongan_3.pdf', 'application/pdf', 492100, 'Dokumen Sokongan 3', 'pemohon', '010201100753', '2025-06-09 04:39:48');
...
(2, '010201100753', 'WK01', 'boss@customs.gov.my', 'NO 64 JALAN PULAU INDAH U10/59', 'TAMAN SUBANG IMPIAN', '40170', 'SHAH ALAM', 'SELANGOR', 'Kompleks Kastam WPKL, 22', 'Jalan SS 6/3 Kelana Jaya', '47301', 'Petaling Jaya', 'Selangor', '2024-01-01', '2024-06-02', 'Sayyidati', 'Hawa', '111111111111', 'Dunia Tipu Tipu', 'Akhirat yang benar', '99999', 'Konoha', 'Land Of Fire', 'TERENGGANU', 'WAN KHAIRUZZAMAN WAN HARUN', '010101100101', 'TERENGGANU', '891 KAMPUNG BARU', '-', '23000', 'DUNGUN', 'TERENGGANU', 'DUNGUN', 'ANISAH BINTI ABDULLAH', '020202020202', 'TERENGGANU', 'Pantai Baru', 'Chendering', '23000', 'Kuala Terengganu', 'Terengganu', 'Kuala Terengganu', 'diri_sendiri', '2025-06-13', '2025-06-14', '2025-06-13', '2025-06-15', 'SUBANG', 'SARAWAK', 1, '2025-06-09', NULL, 'Belum Pasti', '2025-06-09 19:00:44', 'Belum Pasti', NULL, '2025-06-09 19:00:44', 'Dikuiri', 'Pemohon', NULL, NULL, 'IC tidak Lengkap', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-09 04:33:51', '2025-06-09 19:00:44', 1, 'Hantar', 0);
...
ALTER TABLE `wilayah_asal`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_kp` (`user_kp`);
...
ALTER TABLE `wilayah_asal_pengikut`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `kp_pengikut` (`kp_pengikut`),
  ADD KEY `wilayah_asal_id` (`wilayah_asal_id`);

...
// Query user table
$sql = "SELECT * FROM user JOIN wilayah_asal ON user.kp = wilayah_asal.user_kp WHERE status = 'Menunggu pengesahan penyemak2 HQ'";
...
<div class="main-container">
    ...
    <h5 class="mb-3">Senarai Pemohon Wilayah Asal (Semakan II) </h5>

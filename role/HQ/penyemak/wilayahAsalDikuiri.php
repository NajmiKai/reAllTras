...
// Query user table
$sql = "SELECT * FROM user JOIN wilayah_asal ON user.kp = wilayah_asal.user_kp WHERE status = 'Kembali ke penyemak HQ'";
...
<div class="main-container">
    ...
    <h5 class="mb-3">Senarai Pemohon Wilayah Asal (Permohonan Dikuiri) </h5>
                    ...
                    <table class="table table-hover" id="myTable">
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td><a class="button" href="viewdetailsdikuiri.php?kp=<?= $user['kp'] ?>">View Details</a></td>
                            </tr>
                        <?php endforeach; ?>
                            <?php else: ?>
                                <tr>

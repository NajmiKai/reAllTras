...
<div class="container">
    <form method="POST" enctype="multipart/form-data" action="send_mail.php">
        ...
        <!-- Maklumat Permohonan -->
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark">BAHAGIAN IBU PEJABAT (PELULUS)</div>
            <div class="card-body row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="status_permohonan" id="status_select" required onchange="toggleUlasan()">
                        ...
                        <option value="lulus">Diluskan</option>
                        <option value="tidakLulus">Tidak diluluskan</option>
                    </select>
                </div>

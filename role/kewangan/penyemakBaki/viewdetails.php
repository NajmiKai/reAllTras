...
<div class="container">
    <form method="POST" enctype="multipart/form-data" action="send_mail.php">
        ...
        <!-- Maklumat Permohonan -->
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark">BAHAGIAN CAWANGAN KEWANGAN (PENYEMAK BAKI)</div>
            <div class="card-body row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Baki Peruntukan(RM): </label>
                    <input type="number" class="form-control" name="baki" placeholder="Masukkan Jumlah Baki Peruntukan(RM)">
                </div>
            </div>
        </div>

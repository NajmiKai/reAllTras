...
// Query user table
$sql = "SELECT * FROM user JOIN wilayah_asal ON user.kp = wilayah_asal.user_kp WHERE status = 'Menunggu pengesahan penyemak baki kewangan'";
                    ...
                    <table class="table table-hover" id="myTable">
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="button" href="viewdetails.php?kp=<?= $user['kp'] ?>">Lihat</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                            <?php else: ?>

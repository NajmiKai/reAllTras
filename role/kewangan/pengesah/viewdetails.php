...
<div class="container">
    <form method="POST" enctype="multipart/form-data" action="send_mail.php">
        ...
        <!-- Maklumat Permohonan -->
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark">BAHAGIAN CAWANGAN KEWANGAN (PENGESAH)</div>
            <div class="card-body row">              
                <div class="col-md-6 mb-3">
                    <label for="tatatertib_select" class="form-label">Baki</label>
                    <select class="form-select" name="hukuman_tatatertib" id="tatatertib_select" required onchange="toggleUlasan()">
                        <option value="">-- Sila Pilih --</option>
                        <option value="ada">Disahkan baki peruntukan mencukupi</option>
                        <option value="tiada">Peruntukan tidak mencukupi</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="text-end mb-5">
            ...
            <a href="wilayahAsal.php" class="btn btn-secondary">Kembali</a>
        </div>
    </form>
</div>
<?php else: ?>

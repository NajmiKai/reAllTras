...
$submenuOpen = in_array($currentPage, ['permohonanPengguna.php', 'permohonanIbuPejabat.php', 'permohonanDikuiri.php']);
    ...
    if ($application_data) {
        ...
        $ulasan_by_role = [
            'Pengesah CSM' => 
            ($application_data['ulasan_pengesah_csm1'] ?? '') . 
            "\n\n" . 
            ($application_data['ulasan_pengesah_csm2'] ?? ''),
            ...
            'Pengesah Kewangan' => $application_data['ulasan_pengesah_kewangan'] ?? '',
        ];
...
<div class="main-container">
   ...
   <div class="sidebar" id="sidebar">
        ...
        <div id="wilayahSubmenu" class="submenu" style="display: <?= $submenuOpen ? 'block' : 'none' ?>;">
            ...
            <a href="permohonanDikuiri.php" class="active">Permohonan Dikuiri</a>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach ($ulasan_by_role as $peranan => $ulasan): ?>
                        <?php if (!empty(trim($ulasan)) && $ulasan !== '-'): // Only show if ulasan is not empty ?>
                        <tr>

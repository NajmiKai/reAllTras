...
<div class="container">
    <form method="POST" enctype="multipart/form-data" action="send_mail.php">
        ...
        <!-- Maklumat Permohonan -->
        <div class="card mb-4">
            <div class="card-header bg-warning text-dark">BAHAGIAN CAWANGAN SUMBER MANUSIA (PBR)</div>
            <div class="card-body row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="status_permohonan" id="status_select" required onchange="toggleUlasan()">
                        ...
                        <option value="lulusPBRCSM1">Diluluskan</option>
                        <option value="dikuiri">Dikuiri</option>
                    </select>
                </div>
        ...
        <div class="text-end mb-5">
            ...
            <a href="permohonanPengguna.php" class="btn btn-secondary">Kembali</a>
        </div>
    </form>
</div>
<?php else: ?>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt_wilayah = $conn->prepare("UPDATE wilayah_asal SET status = ?, ulasan_pengesah_csm1 = ?, pengesah_csm1_id = ?, tarikh_keputusan_pengesah_csm1 = ? WHERE id = ?");
            ...
            while ($data = $result->fetch_assoc()) {
                ...
                try {
                    ...
                    $mail->Body = "
                        ...
                        <p>Permohonan Tambang Ziarah Wilayah (TZW) oleh pegawai telah disemak dan dikemukakan untuk proses semakan bagi mendapat pertimbangan serta kelulusan pihak tuan/puan.</p>
        
                        <p>Sila klik pautan/butang di bawah untuk tindakan lanjut dan maklumat permohonan.</p>
        
                        <p><a href='http://localhost/reAllTras/role/HQ/penyemak/viewdetails.php?kp=$kp'><b><u>PAPAR MAKLUMAT PERMOHONAN</u></b></a></p><br>

...
function getStatusFilter($status, $approved_status = 'dalam_proses') {
    switch ($status) {
        case 'processing':
            return "status IN ('Menunggu pengesahan pengesah CSM', 'Menunggu pengesahan pengesah2 CSM')";
        case 'approved':
            $selesai = "status NOT IN ('Menunggu pengesahan pengesah CSM', 'Menunggu pengesahan pengesah2 CSM') AND status_permohonan = 'Selesai'";
            $not_selesai = "status NOT IN ('Menunggu pengesahan pengesah CSM', 'Menunggu pengesahan pengesah2 CSM') AND status_permohonan != 'Selesai'";
                            ...
                            if ($result && $result->num_rows > 0): ?>
                                <?php while ($user = $result->fetch_assoc()): ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($user['status'] == 'Menunggu pengesahan pengesah2 CSM'){ ?>

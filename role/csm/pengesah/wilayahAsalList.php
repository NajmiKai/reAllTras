...
function getStatusFilter($status, $admin_id) {
    switch ($status) {
        ...
        case 'approved':
            return "(pengesah_csm1_id = $admin_id OR pengesah_csm2_id = $admin_id)";
        case 'rejected':
            return "1 = 0"; // This ensures no rows returned
        case 'total':
        default:
            return "(pengesah_csm1_id = $admin_id OR pengesah_csm2_id = $admin_id OR status IN ('Menunggu pengesahan pengesah CSM', 'Menunggu pengesahan pengesah2 CSM'))";
    }
}

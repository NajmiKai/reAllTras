...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt_wilayah = $conn->prepare("UPDATE wilayah_asal SET status = ?, ulasan_pengesah_csm2 = ?, pengesah_csm2_id = ?,  status_permohonan= ?, kedudukan_permohonan= ?, tarikh_keputusan_pengesah_csm2 = ? WHERE id = ?");

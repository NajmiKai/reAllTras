...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $no_kp_pemohon = $_POST['no_kp_pemohon'];
        $tarikh_lahir_pemohon = $_POST['tarikh_lahir_pemohon'];
        $alamat_pemohon = $_POST['alamat_pemohon'];
        $poskod_pemohon = $_POST['poskod_pemohon'];
        $bandar_pemohon = $_POST['bandar_pemohon'];
        $negeri_pemohon = $_POST['negeri_pemohon'];
        $no_tel_pemohon = $_POST['no_tel_pemohon'];
        $emel_pemohon = $_POST['emel_pemohon'];

        // Update applicant information in database
        $sql = "UPDATE wilayah_asal SET 
            nama_pemohon = ?,
            no_kp_pemohon = ?,
            tarikh_lahir_pemohon = ?,
            alamat_pemohon = ?,
            poskod_pemohon = ?,
            bandar_pemohon = ?,
            negeri_pemohon = ?,
            no_tel_pemohon = ?,
            emel_pemohon = ?,
            wilayah_asal_from_stage = 'Complete'
            WHERE id = ?";
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['applicant_info'] = [
                'nama_pemohon' => $nama_pemohon,
                'no_kp_pemohon' => $no_kp_pemohon,
                'tarikh_lahir_pemohon' => $tarikh_lahir_pemohon,
                'alamat_pemohon' => $alamat_pemohon,
                'poskod_pemohon' => $poskod_pemohon,
                'bandar_pemohon' => $bandar_pemohon,
                'negeri_pemohon' => $negeri_pemohon,
                'no_tel_pemohon' => $no_tel_pemohon,
                'emel_pemohon' => $emel_pemohon
            ];

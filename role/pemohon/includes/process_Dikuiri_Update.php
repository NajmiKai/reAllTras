...
try {
    ...
    $sql = "UPDATE wilayah_asal SET 
            ...
            pegSulit_csm_id = NULL,
            tarikh_keputusan_pengesah_csm1 = NULL,
            tarikh_keputusan_csm2 = NULL,
            pbr_csm2_id = NULL,
            tarikh_keputusan_pegsulit_csm = NULL,
            pengesah_csm2_id = NULL,
            tarikh_keputusan_pengesah_csm2 = NULL,
            ulasan_pengesah_csm2 = NULL,
            penyemak_HQ1_id = NULL,
            ulasan_penyemak_HQ = NULL,
            tarikh_keputusan_penyemak_HQ1 = NULL,
            pengesah_HQ_id = NULL,
            ulasan_pengesah_HQ = NULL,
            tarikh_keputusan_pengesah_HQ = NULL,
            pelulus_HQ_id = NULL,
            ulasan_pelulus_HQ = NULL,
            tarikh_keputusan_pelulus_HQ = NULL,
            penyemak_HQ2_id = NULL,
            tarikh_keputusan_penyemak_HQ2 = NULL,
            penyemakBaki_kewangan_id = NULL,
            tarikh_keputusan_penyemakBaki_kewangan = NULL,
            ulasan_penyemakBaki_kewangan = NULL,
            pengesah_kewangan_id = NULL,
            tarikh_keputusan_pengesah_kewangan = NULL,
            ulasan_pengesah_kewangan = NULL,
            penyediaKemudahan_kewangan_id = NULL,
            tarikh_keputusan_penyediaKemudahan_kewangan = NULL
            WHERE id = ?";
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p><a href='" . getFullUrl("role/csm/pegawaiSulit/viewdetails.php?kp={$user_data['kp']}") . "'><b><u>PAPAR MAKLUMAT PERMOHONAN</u></b></a></p><br>
